%The chromosomes generated in the population are one row of numbers, these
%needed to be encoded to see which numbers correspond to which weights. The
%encode script returns a 1x4 cell. The 1st cell returns the input layer
%weights, the 2nd contains cells which are used in the hidden layers, the
%3rd returns the output layer weights, and the 4th determines the order of
%magnitude of the final output value.
